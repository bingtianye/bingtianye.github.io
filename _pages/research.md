...
一个重要方向是利用量子多体物理来产生对传感有用的纠缠态。例如，自发对称性破缺、淬火动力学和绝热演化可以为制备可扩展的自旋压缩态提供自然机制。这些状态能够降低量子投影噪声，从而提升测量灵敏度。

另一个方向是利用量子多体系统自身的动力学特征进行传感。量子混沌和信息 scrambling 可以将外界微小扰动快速编码到多体系统的全局自由度中，因此有潜力用于多参数传感、宽带信号探测和量子设备表征。除了传统的参数估计，我也关注更广义的量子测量任务，例如信号搜索、模式识别，以及对时间依赖或空间结构化信号的整体性质进行估计。

**相关成果：** 在量子增强精密测量方向，我研究如何利用多体相互作用制备可扩展的计量学纠缠态。相关工作包括在 Rydberg 原子阵列中实现可扩展的自旋压缩，以及从有限温度 easy-plane 磁性出发理解自旋压缩的产生机制。这些工作将量子计量学与多体磁性、非平衡动力学和可编程量子模拟联系起来。
